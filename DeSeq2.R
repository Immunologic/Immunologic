...
setwd("/Users/anjoom/R /RNA-seq-workflow/RNA-seq")
getwd()
if (!require("BiocManager", quietly = TRUE))
  install.packages("BiocManager")
BiocManager::install(DESeq2)
library("DESeq2")
Count_data = read.csv( "/Users/anjoom/R /RNA-seq-workflow/RNA-seq/GSE161833_2h_countdata.csv", header = T, sep = ",",row.names="Geneid",check.names = FALSE)
View(Count_data)
dim(Count_data)
Col_data = read.table("/Users/anjoom/R /RNA-seq-workflow/RNA-seq/2h_metadata.csv", header = T, sep = ",",row.names = "Column")
View(Col_data)
rownames(Col_data)
colnames(Count_data)
